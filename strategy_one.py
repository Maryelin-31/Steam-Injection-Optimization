...
def workspace(rate_inj, year_inje):
    ...
    injector = model.add_injector(cell=cell_inj, fluid_id=[0, 1], flu=flu2,
    ...
    # for cell in model.cells:
    #     # print(cell)
    #     print(cell, cell.face_number, cell.get_face(0))
    
    # print(model.get_face(model.face_number - 1))
    ...
    def iterate():
        ...
        for step in range(100000000):
            ...
            if step % 100 == 0:
                ...
                print(f'time = {time / (3600 * 24 )} , step = {step}')
